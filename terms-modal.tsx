        ...
        <div className="p-6">
          ...
          <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
            <div>
              ...
              <p>
                본 HTP 심리검사는 내담자의 심적 특성, 정서 상태, 내면의 욕구 및 갈등을 비언어적인 방식으로 이해하기 위한
                목적으로 시행됩니다. 검사 결과는 전문 상담가의 상담 과정에서 내담자 자기 이해를 돕는 참고 자료로만
                활용되며, 어떠한 의학적 진단이나 법적 효력을 갖지 않습니다.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                수집한 개인정보는 상담 서비스가 진행되는 기간 동안 보유 및 이용되며, 서비스 종료 후에는 정보주체의 파기
                요청 시 지체 없이 파기됩니다. 단, 관련 법령에 따라 보존할 필요가 있는 경우 해당 법령에서 정한 기간 동안
                보관할 수 있습니다.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                귀하는 위 개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있습니다. 다만, 동의 없이는 대면 동의를
                거부할 경우, 검사 진행 및 결과 해석이 불가능하여 관련 서비스를 제공받으실 수 없습니다.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                본 검사는 내담자의 주관적인 그림 표현을 바탕으로 한 심리적 해석을 제공합니다. 본 검사는 HTP 기반
                간이검사로써, 학술적인 진단이 아니며 상담의 참고 자료로 활용될 뿐입니다. 검사 결과의 해석이나 이를
                기반으로 한 어떠한 결정에 대해서도 본 기관은 법적 책임을 지지 않습니다.
              </p>
            </div>
          </div>
